...
const smokeTest: Sample = {
  ...
  yamlId: 'smoke-test',
  lanes: [
    { color: 'blue',  name: { en: 'Backend', zh: '后端' },     driver: 'opencode · opencode/big-pickle' },
    { color: 'green', name: { en: 'Ops',     zh: '运维' },     driver: 'shell' },
    { color: 'pink',  name: { en: 'Review',  zh: '审查' },     driver: 'claude-code · opus' },
  ],
  tasks: [
    { id: 't1', lane: 0, col: 0, color: 'blue',   glyph: '◆',
      title: { en: 'Plan the /health change', zh: '规划 /health 变更' },
      driverLine: 'opencode · opencode/big-pickle', chips: ['g', 'r', 'default'] },
    { id: 't2', lane: 0, col: 1, color: 'blue', glyph: '◆',
      title: { en: 'Implement /health',    zh: '实现 /health' },
      driverLine: 'opencode · opencode/big-pickle', chips: ['default', 'y', 'r'] },
    { id: 't3', lane: 0, col: 2, color: 'blue',  glyph: '◆',
      title: { en: 'Self-review the diff', zh: '自审 diff' },
      driverLine: 'opencode · opencode/big-pickle', chips: ['default', 'default'] },
    ...
    { id: 't5', lane: 1, col: 1, color: 'green',  glyph: '⚠',
      title: { en: 'Wait for signal file', zh: '等待信号文件' },
      driverLine: 'trigger · file .signals/done' },
    { id: 't6', lane: 2, col: 3, nudge: 28, color: 'pink', glyph: '◆',
      title: { en: 'Summarize for release notes', zh: '汇总生成发布说明' },
      driverLine: 'claude-code · opus', chips: ['default', 'b'] },
  ],
  frames: [
    {
...
const parallelReview: Sample = {
  ...
  lanes: [
    ...
    { color: 'teal',   name: { en: 'Performance', zh: '性能' },     driver: 'codex · gpt-5.3-codex' },
    { color: 'pink',   name: { en: 'Style',       zh: '风格' },     driver: 'opencode · opencode/big-pickle' },
  ...
  tasks: [
    ...
    { id: 'perf', lane: 1, col: 1, color: 'teal',   glyph: '◆',
      ...
      driverLine: 'codex · gpt-5.3-codex',    chips: ['y', 'default', 'default'] },
    { id: 'sty',  lane: 2, col: 1, color: 'pink',   glyph: '◆',
      title: { en: 'Style & idioms',      zh: '风格与习惯' },
      driverLine: 'opencode · opencode/big-pickle', chips: ['g', 'default'] },
...
const bugTriage: Sample = {
  ...
  lanes: [
    ...
    { color: 'orange', name: { en: 'Fix',      zh: '修复' },     driver: 'opencode · opencode/big-pickle' },
  ],
  tasks: [
    ...
    { id: 'fix',      lane: 2, col: 2, color: 'orange', glyph: '◆',
      ...
      driverLine: 'opencode · opencode/big-pickle', chips: ['g', 'default', 'y'] },
...
const migrationGate: Sample = {
  ...
  lanes: [
    ...
    { color: 'orange', name: { en: 'Apply',    zh: '执行' }, driver: 'codex · gpt-5.3-codex' },
  ],
  tasks: [
    ...
    { id: 'apply',   lane: 2, col: 2, color: 'orange', glyph: '◆',
      ...
      driverLine: 'codex · gpt-5.3-codex',     chips: ['r', 'y', 'default'] },
    { id: 'verify',  lane: 2, col: 3, color: 'orange', glyph: '▶',
      title: { en: 'Verify rollback',   zh: '验证回滚' },
      driverLine: 'shell · migrate-verify.sh' },
  ],
  frames: [
